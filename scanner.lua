print("Phantom Cannon Scanner Loaded")

local player = game.Players.LocalPlayer

local gui = Instance.new("ScreenGui")
gui.Name = "CannonScanner"
...
title.Text = "Phantom Cannon Scanner"
...
scan.MouseButton1Click:Connect(function()
    ...
    box.Text = "Scanning Phantom Cannon...\n"

    for _,v in pairs(workspace:GetDescendants()) do

        if string.find(string.lower(v.Name),"phantom")
        or string.find(string.lower(v.Name),"cannon")
        or string.find(string.lower(v.Name),"ghost") then
